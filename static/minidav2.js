...
function req(resource, method, format = (x) => x.text()) {
	...
	return fetch("https://cloud.gatrobe.de/remote.php/dav/files/5f6b20a8-9068-11ef-89d5-bc2411f3d92c/GatrobeLib" + "/" + path.replace("/remote.php/dav/files/5f6b20a8-9068-11ef-89d5-bc2411f3d92c/GatrobeLib", ""), {
		method: method,
		headers: new Headers({
